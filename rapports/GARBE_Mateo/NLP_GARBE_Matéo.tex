...
Figure \ref{fig:NMF} illustrates the temporal distribution of the six main topics over time, while Figure \ref{fig:topics_evolution} shows the overrepresentation of topics across political parties and elections. Across all elections, appeals to political change and alternation remain the most dominant theme. Some election-specific dynamics also emerge, such as the defence of workers and anti-capitalism in the 1973, 1981 and 1988 elections, coinciding with strong performances by the far left, particularly Lutte ouvrière, but also the Parti communiste (PCF). Liberalism and taxation also emerge as distinctive themes in the 1988 election, notably under the influence of the Front National. Finally, the increased focus on immigration stands out in the 1993 election, again strongly associated with the Front National.

Calls for alternation also appear broadly consistent with the political context. For example, the 1981 legislative election took place just after the election of François Mitterrand to the presidency, and neither the Parti socialiste nor the Parti socialiste unifié placed particular emphasis on alternation that year, relative to other parties. By contrast, the 1988 election followed a period of cohabitation between François Mitterrand and a right-wing parliamentary majority, and the Parti socialiste this time clearly campaigned on alternation.

Similarly, the rise of Lutte ouvrière in the 1980s and of the Front National in the 1990s did not occur through appeals to alternation. Instead, these parties pursued strategies centred on a limited number of specific subjects rather than on the conquest of a ruling majority. More generally, alternation appears somewhat overrepresented among major political parties, likely because it offers a less divisive and more electorally consensual framing.
...
Overall, workers are overrepresented in electoral manifestos emphasizing defense of workers between 1973 and 1988. This pattern is particularly pronounced within Lutte ouvrière, where these themes constitute a central ideological focus and where workers are likewise strongly overrepresented.
Calls for alternation are also a theme frequently advanced by candidates from agricultural backgrounds. In 1993, the rise of immigration as a campaign issue was driven primarily by popular occupational groups, largely excluding executives (cadres) and intermediate professions, who were themselves heavily overrepresented respectively within the Rassemblement pour la République and the Parti socialiste, two parties whose campaign agendas placed little, if any, emphasis on immigration. More generally, candidate social profiles appear to be strongly correlated with party affiliation, and therefore with the themes promoted by parties. This sometimes produces seemingly surprising results, such as artisans, shopkeepers, and business owners being overrepresented in 1993 within the class struggle theme, although this occupational category remains highly heterogeneous.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.7\linewidth}
          \centering
          \includegraphics[width=1\linewidth]{theme_1981.png}
          \caption{1981}
    \end{subfigure}
    \vspace{0.5cm}
    \begin{subfigure}{0.7\linewidth}
...
\begin{figure}
    ...
    \begin{subfigure}{0.7\linewidth}
     \centering
     \includegraphics[width=0.8\linewidth]{occ_top_1973.png}
          \caption{1973}
    \end{subfigure}
    \vspace{0.5cm}
    \begin{subfigure}{0.7\linewidth}
